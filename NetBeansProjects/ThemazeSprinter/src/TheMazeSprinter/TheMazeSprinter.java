...
public class TheMazeSprinter extends BasicGameState {
	...
	public TheMazeSprinter(int xSize, int ySize) {
	...
	throws SlickException {
		...
		grassMap = new TiledMap("/home/freyes/NetBeansProjects/New Folder/Official_map");
